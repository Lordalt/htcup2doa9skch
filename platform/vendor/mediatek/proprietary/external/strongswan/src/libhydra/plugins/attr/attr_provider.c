...
static attribute_type_key_t keys[] = {
	...
	{"pcscf",         P_CSCF_IP4_ADDRESS,   P_CSCF_IP6_ADDRESS},
	{"intnetmask",    INTERNAL_IP4_NETMASK, INTERNAL_IP6_NETMASK},
	{"intsubnet",     INTERNAL_IP4_SUBNET,  INTERNAL_IP6_SUBNET},
...
static void load_entries(private_attr_provider_t *this)
{
	...
	keys[1].v4 = get_cust_setting_int(CUST_PCSCF_IP4_VALUE);
	keys[1].v6 = get_cust_setting_int(CUST_PCSCF_IP6_VALUE);
